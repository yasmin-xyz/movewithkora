...
- This applies just as much to standing Build-section poses that are part of a flowing sequence (e.g. Warrior II, Extended Side Angle, Triangle Pose) as it does to obvious static holds — these are NOT exempt just because they're mid-flow. Give each one a breath count framed around what it's doing physically, e.g. "Breath: Hold for 3-5 breaths to build heat in the front quad" or "Cue: Hold for 4-5 breaths, engaging the legs to wake up the standing foundation." A pose with no count at all leaves the instructor guessing how long to actually hold it — this must not happen anywhere in Build.
